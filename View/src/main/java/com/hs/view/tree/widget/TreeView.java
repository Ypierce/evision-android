package com.hs.view.tree.widget;
...
public class TreeView extends ExpandableListView implements OnScrollListener, OnGroupClickListener {
    ...
    private BaseTreeViewAdapter mUpdater;
    ...
    private TreeItemClickListener childClickListener;
    ...
    public void setItemClickListener(TreeItemClickListener treeItemClickListener){
    	this.childClickListener = treeItemClickListener;
    	...
    	setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
				Object item = mUpdater.getChild(groupPosition, childPosition);
				if(mUpdater.getSelectedItem() == item){
					item = null;
				}

				mUpdater.setSelectedItem(item);
				mUpdater.notifyDataSetInvalidated();
				if(childClickListener != null){
					childClickListener.onClick(item);
				}
				return false;
			}
		});
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        if(adapter instanceof BaseTreeViewAdapter) {
            mUpdater = (BaseTreeViewAdapter) adapter;
        } else {
            throw new IllegalArgumentException("The adapter must instanceof BaseTreeViewAdapter.");
        }
    }
