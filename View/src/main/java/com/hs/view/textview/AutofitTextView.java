...
import com.hs.view.textview.part.AutofitHelper;


/**
 * 可以适应定宽的Textview 会自动缩小字体大小
 * 
 * @author gm
 *
 ...
 */
public class AutofitTextView extends TextView implements
	...
	/**
	 * Returns whether or not the text will be automatically re-sized to fit its
	 * constraints.
	 */
