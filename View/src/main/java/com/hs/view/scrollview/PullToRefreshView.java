package com.hs.view.scrollview;
...
public class PullToRefreshView extends LinearLayout {
	 ...
	 * 判断是否需要上拉加载
	 */
	private boolean is_enable_to_foot_refresh = true;
	/**
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			} else if (mPullState == PULL_UP_STATE && is_enable_to_foot_refresh) {// 执行上拉
	...
	public void setFootRefreshEnable(boolean b) {
		is_enable_to_foot_refresh = b;
	}
}
