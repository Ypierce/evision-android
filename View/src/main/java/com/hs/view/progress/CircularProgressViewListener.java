...
public interface CircularProgressViewListener {
	/**
	 * Called when setProgress(float currentProgress) is called (determinate
	 * only)
	 *
	 ...
	 *
	 * @param currentProgress
	 *            The progress that was set and this view has reached in its
	 *            animation.
	 */
	 ...
	 *            true if mode was set to indeterminate, false otherwise.
	 */
